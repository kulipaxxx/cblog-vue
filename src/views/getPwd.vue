        ...
        <div id="admin">
            <div class="pos" v-loading="loading">
                ...
                >
                    ...
                    <div class="tips">
                        <span style="margin-right:20px;font-size: 16px">如果您回忆了账号请 <button style="background-color: white;color:#409EFF;cursor:pointer;border: 0px" @click="toLogin">登录</button></span>
                    </div>
                </el-form>
            </div>
        </div>
...
<script>
    import {code, getPassword} from "../api/reception/login";
    export default {
        name: "getPwd",
